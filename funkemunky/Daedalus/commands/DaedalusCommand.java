    ...
    public boolean onCommand(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (args.length == 0) {
            ...
            if (args[0].equalsIgnoreCase("help")) {
                ...
                sender.sendMessage(C.Gray + "/daedalus" + C.Reset + " clean" + C.Gray + " - Run Java Garbage-Collector.");
                sender.sendMessage(C.Gray + "/daedalus" + C.Reset + " reload" + C.Gray + "   - Reload Daedalus.");
                sender.sendMessage(C.Gray + "/daedalus" + C.Reset + " violations <player>" + C.Gray + " - Gets the violations of a player.");
