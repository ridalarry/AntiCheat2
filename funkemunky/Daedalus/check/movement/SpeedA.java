...
import funkemunky.Daedalus.utils.*;
...
public class SpeedA extends Check {
    ...
    public SpeedA(funkemunky.Daedalus.Daedalus Daedalus) {
    ...
    public void CheckSpeed(PlayerMoveEvent event) {
        ...
        if (Count >= 3) {
            ...
            Count = 0;
            getDaedalus().logCheat(this, player, Math.round(percent) + "% faster than normal", prob);
        }
        if (!player.isOnGround()) {
